...
function Pane({ pane, state, workspaceId, onUploadPdf, onOpenEvidence, onSetCursor, onSelectSource, onSourceKnowledgeAction, onRunModelAction, onStudioAction }) {
...
export function AdaptiveWorkspace({ workspaceId = "", routeId = "workspace_detail", screenId = "workspace_detail", onUploadPdf }) {
