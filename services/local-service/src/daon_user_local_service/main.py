...
from .bootstrap import (
    EXIT_BOOTSTRAP_INVALID,
    EXIT_BOOTSTRAP_TIMEOUT,
    BootstrapReadTimeout,
    read_bootstrap,
    read_bootstrap_line,
)
from .protocol import Bootstrap, BootstrapError, ready_envelope
...
def run(bootstrap: Bootstrap | None = None) -> int:
    if bootstrap is None:
        try:
            bootstrap = read_bootstrap(
                sys.stdin.buffer,
                read_line=read_bootstrap_line,
            )
