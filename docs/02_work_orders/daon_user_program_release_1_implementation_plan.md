...
| G0-BASELINE | M0 결정·추적표·환경 기준선 승인 | 미착수 | 미정 |
...
| --- | --- | --- | --- | --- | --- |
| M0 | 승인 문서·결정·추적·환경 기준선 | 없음 | R1-M0-A01~A04 · 설계자/승인자 Activity | 핵심 미확정 0, G0 승인 | `BLOCKED` |
...
G0-DESIGN과 G0-PLAN은 `APR-G0-DESIGN-20260720-01`, `APR-G0-PLAN-20260720-01`로 승인되었다. 다음 실행 주체는 어울1이며 R1-M0-A01~A04와 G0-BASELINE 승인 기준선을 준비한다. 신산님의 G0-BASELINE 승인 전까지 구현 상태는 `BLOCKED`이고 구현 코드는 수정하지 않는다.
