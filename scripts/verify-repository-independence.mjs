...
try {
  ...
  console.log(`components=${result.stats.component_count} edges=${result.stats.edge_count} package_files=${result.stats.manifest_count} scanned_files=${result.stats.scanned_files} violations=${result.violations.length}`);
