...
export function ScreenPreferencesPane() {
  ...
  return <main className="screen-preference-page" aria-labelledby="screen-preference-title">
    <header><a className="screen-preference-home" href="/notebooks">Notebook으로</a><p className="section-kicker">DISPLAY</p><h1 id="screen-preference-title">화면 설정</h1><p>Notebook과 Source·대화·산출물은 변경하지 않습니다.</p></header>
